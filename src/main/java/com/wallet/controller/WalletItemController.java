...
public class WalletItemController {
	...
	public ResponseEntity<Response<WalletItemDTO>> create(
			@Valid @RequestBody WalletItemDTO dto, BindingResult result) {
		...
		WalletItem wi = service.save(dto.toEntity());
		
		response.setData(new WalletItemDTO(wi));
	...
	public ResponseEntity<Response<Page<WalletItemDTO>>> findBetweenDates(@PathVariable("wallet") Long wallet,
		...
		Page<WalletItemDTO> dto = items.map(i -> new WalletItemDTO(i));
	...
	public ResponseEntity<Response<List<WalletItemDTO>>> findByWalletIdAndType(
		...
		list.forEach(i -> dto.add(new WalletItemDTO(i)));
		response.setData(dto);
		return ResponseEntity.ok().body(response);
	}
	...
	public ResponseEntity<Response<WalletItemDTO>> update(@Valid @RequestBody WalletItemDTO dto, BindingResult result) {
		...
		WalletItem saved = service.save(dto.toEntity());
