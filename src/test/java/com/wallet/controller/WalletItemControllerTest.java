...
class WalletItemControllerTest {
	...
	void testSave() throws Exception {
		...
		.andExpect(jsonPath("$.data.wallet_id").value(ID))
		;
	}
	...
	public void testFindBetweenDates() throws Exception {
		...
		.andExpect(jsonPath("$.data.content[0].wallet_id").value(ID))
		;
	}
	...
	public void testFindByType() throws Exception {
		...
		.andExpect(jsonPath("$.data.[0].wallet_id").value(ID))
		;
	}
	...
	public void testDeleteInvalid() throws Exception {
		...
		mvc.perform(MockMvcRequestBuilders.delete(URL + "/" + idToDelete)
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON))
		.andExpect(status().isNotFound())
		.andExpect(jsonPath("$.data").doesNotExist())
		.andExpect(jsonPath("$.errors[0]").value("WalletItem de id " + idToDelete + " não encontrada"));
	}
